define(
    ...
    function ($, _, __, Routing) {
        ...
        var triggerUpdate = function () {
            $el.trigger('tree.updated', "test");
        };

        var getTreeUrl = function () {
           return Routing.generate('elvis_connector_get_categorie_roots')
        };

        var getChildrenUrl = function () {
            return Routing.generate('elvis_connector_get_categorie');
        };
                ...
                json_data: {
                    ajax: {
                        ...
                        /* success: function (data) {
                         alert('chield' + JSON.stringify(data));
