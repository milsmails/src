define(
    ['jquery', 'underscore', 'oro/datafilter/number-filter', 'fotelvisconnector/js/picker/elvis-jstree', 'oro/mediator'],
    function ($, _, NumberFilter, TreeView, mediator) {
        ...
        return NumberFilter.extend({
            ...
            initialize: function(urlParams, gridName, categoryBaseRoute, container) {
                ...
                /*this.listenTo(mediator, 'tree.updated', function(test) {
