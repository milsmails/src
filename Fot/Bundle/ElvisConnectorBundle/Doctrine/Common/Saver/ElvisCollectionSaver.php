...
namespace Fot\Bundle\ElvisConnectorBundle\Doctrine\Common\Saver;
...
class ElvisCollectionSaver implements SaverInterface, BulkSaverInterface
{
    /** @var ObjectManager */
   ...
   // protected $compGenerator;
    ...
    public function __construct(
        ...
        throw new \InvalidArgumentException(
            sprintf(
                'Expects a "Fot\Component\ElvisConnector\Model\ElvisCollectionInterface", "%s" provided.',
                ClassUtils::getClass($objectManager)
            )
        );
